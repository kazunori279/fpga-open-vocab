# `a sink on the left` against `a sink on the right`
...
uv run --script tools/mirror_pairs.py \
    --out bench/stills/20260822-mirror-sink --cat "sink" \
    --pos "a sink on the left" --neg "a sink on the right" \
...
| --- | --- | --- | --- |
| teacher 1152 | 0.510 | 0.54 | 16/28 |
| pca 512 | 0.496 | 0.51 | 14/28 |
| student fp32 | 0.503 | 0.55 | 14/28 |
