# `a cup on the left` against `a cup on the right`
...
uv run --script tools/mirror_pairs.py \
    --out bench/stills/20260822-mirror-cup --cat "cup" \
    --pos "a cup on the left" --neg "a cup on the right" \
...
| --- | --- | --- | --- |
| teacher 1152 | 0.490 | 0.52 | 14/30 |
| pca 512 | 0.508 | 0.53 | 17/30 |
| student fp32 | 0.448 | 0.51 | 13/30 |
