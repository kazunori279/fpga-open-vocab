...
def main() -> int:
    ...
    ap.add_argument("--enrol", action="append", default=[], metavar="FRAME:KEY",
                    help="M21. At the board's frame FRAME, press KEY - '0' for "
                         ...
                         "'L' to freeze the camera's gain where it stands - the "
                         "one loop this board both obeys the mask on and "
                         "survives having frozen, the AE ignoring it and the "
                         "AWB going green, and one press per run because the "
                         "unlock fails 31 times in 56 - 'M' to replace the "
                         "camera "
